...
new_Data_36_30 = pd.read_csv("C:\\Users\\vstok\\Desktop\\36_30_last.csv")
...
def euler_ODE_LFR_1():
    ...
    plt.fill_between(timeline, q_one_L_36_30, q_three_L_36_30, color='dodgerblue', alpha=0.5, label='IQR')
    plt.fill_between(timeline, min_L_36_30, max_L_36_30, color='skyblue', alpha=0.5, label='min, max')
    plt.plot(timeline, median_L_36_30, color='blue', label='median')
    ...
    plt.fill_between(timeline, q_one_C_36_30, q_three_C_36_30, color='tomato', alpha=0.5, label='IQR')
    plt.fill_between(timeline, min_C_36_30, max_C_36_30, color='lightsalmon', alpha=0.5, label='min, max')
    plt.plot(timeline, median_C_36_30, color='r', label='median')
    ...
    plt.fill_between(timeline, q_one_R_36_30, q_three_R_36_30, color='sandybrown', alpha=0.5, label='IQR')
    plt.fill_between(timeline, min_R_36_30, max_R_36_30, color='peachpuff', alpha=0.5, label='min, max')

    plt.plot(timeline, median_R_36_30, color='peru', label='median')
    plt.legend(loc='best', fontsize=15)
    plt.xticks(fontsize=20)
    plt.yticks(fontsize=18)
    plt.xlabel(' ', fontsize=18)
...
#
# ax1.fill_between(timeline, min_L_36_30, max_L_36_30, color='skyblue', alpha=0.5)
# ax1.fill_between(timeline, q_one_L_36_30, q_three_L_36_30, color='dodgerblue', alpha=0.5)
# ax1.plot(timeline, median_L_36_30, color='blue')
# plt.xlim(-1, 31)
# plt.ylim(-1, 101)
...
# fig, ax1 = plt.subplots(1, 1, sharex=True)
#
# ax1.fill_between(timeline, min_C_36_30, max_C_36_30, color='lightsalmon', alpha=0.5)
# ax1.fill_between(timeline, q_one_C_36_30, q_three_C_36_30, color='tomato', alpha=0.5)
# ax1.plot(timeline, median_C_36_30, color='r')
# plt.xlim(-1, 31)
# plt.ylim(-1, 101)
# plt.xlabel('time[min]', fontsize=12)
# plt.ylabel('median fraction of bees[%]', fontsize=12)
...
# fig, ax1 = plt.subplots(1, 1, sharex=True)
#
# ax1.fill_between(timeline, min_R_36_30, max_R_36_30, color='peachpuff', alpha=0.5)
# ax1.fill_between(timeline, q_one_R_36_30, q_three_R_36_30, color='sandybrown', alpha=0.5)
# ax1.plot(timeline, median_R_36_30, color='peru')
# plt.xlim(-1, 31)
# plt.ylim(-1, 101)
# plt.xlabel('time[min]', fontsize=12)
# plt.ylabel('median fraction of bees[%]', fontsize=12)
