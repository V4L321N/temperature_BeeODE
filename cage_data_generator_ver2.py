...
for i in range(0,len(NOISE_CAGE_DATA_0.loc[:,'L'])):
    ...
    MIN_L.append(min/100)
    Q1_L.append(q1/100)
    MEDIAN_L.append(median/100)
    Q3_L.append(q3/100)
    MAX_L.append(max/100)
...
for i in range(0,len(NOISE_CAGE_DATA_0.loc[:,'C'])):
    ...
    q1, median, q3= np.percentile(SAMPLE, [25,50,75])
    min, max = np.min(SAMPLE), np.max(SAMPLE)
    MIN_C.append(min/100)
    Q1_C.append(q1/100)
    MEDIAN_C.append(median/100)
    Q3_C.append(q3/100)
    MAX_C.append(max/100)
...
for i in range(0,len(NOISE_CAGE_DATA_0.loc[:,'R'])):
    ...
    q1, median, q3= np.percentile(SAMPLE, [25,50,75])
    min, max = np.min(SAMPLE), np.max(SAMPLE)
    MIN_R.append(min/100)
    Q1_R.append(q1/100)
    MEDIAN_R.append(median/100)
    Q3_R.append(q3/100)
    MAX_R.append(max/100)
...
'''#####################################################################################################################################'''
######_EXPERIMENT_DATA_#######################################
NOISE_CAGE_DATA_0 = pd.read_csv("NOcage0.csv")
NOISE_CAGE_DATA_1 = pd.read_csv("NOcage1.csv")
NOISE_CAGE_DATA_2 = pd.read_csv("NOcage2.csv")
NOISE_CAGE_DATA_3 = pd.read_csv("NOcage3.csv")
NOISE_CAGE_DATA_4 = pd.read_csv("NOcage4.csv")
NOISE_CAGE_DATA_5 = pd.read_csv("NOcage5.csv")
NOISE_CAGE_DATA_6 = pd.read_csv("NOcage6.csv")
NOISE_CAGE_DATA_7 = pd.read_csv("NOcage7.csv")
NOISE_CAGE_DATA_8 = pd.read_csv("NOcage8.csv")
NOISE_CAGE_DATA_9 = pd.read_csv("NOcage9.csv")
NOISE_CAGE_DATA_10 = pd.read_csv("NOcage10.csv")
NOISE_CAGE_DATA_11 = pd.read_csv("NOcage11.csv")
NOISE_CAGE_DATA_12 = pd.read_csv("NOcage12.csv")
NOISE_CAGE_DATA_13 = pd.read_csv("NOcage13.csv")
NOISE_CAGE_DATA_14 = pd.read_csv("NOcage14.csv")
NOISE_CAGE_DATA_15 = pd.read_csv("NOcage15.csv")
NOISE_CAGE_DATA_16 = pd.read_csv("NOcage16.csv")
NOISE_CAGE_DATA_17 = pd.read_csv("NOcage17.csv")
NOISE_CAGE_DATA_18 = pd.read_csv("NOcage18.csv")
NOISE_CAGE_DATA_19 = pd.read_csv("NOcage19.csv")
#NOISE_CAGE_DATA_20 = pd.read_csv("NOcage20.csv")
...
MOD_NoC_minute_zero_L	= [MIN_L[0]/100,Q1_R[0]/100,MEDIAN_L[0]/100,Q3_L[0]/100,MAX_L[0]/100]
MOD_NoC_minute_fifteen_L = [MIN_L[15]/100,Q1_R[15]/100,MEDIAN_L[15]/100,Q3_L[15]/100,MAX_L[15]/100]
MOD_NoC_minute_thirty_L = [MIN_L[30]/100,Q1_R[30]/100,MEDIAN_L[30]/100,Q3_L[30]/100,MAX_L[30]/100]

MOD_NoC_minute_zero_C	= [MIN_C[0]/100,Q1_R[0]/100,MEDIAN_C[0]/100,Q3_C[0]/100,MAX_C[0]/100]
MOD_NoC_minute_fifteen_C = [MIN_C[15]/100,Q1_R[15]/100,MEDIAN_C[15]/100,Q3_C[15]/100,MAX_C[15]/100]
MOD_NoC_minute_thirty_C = [MIN_C[30]/100,Q1_R[30]/100,MEDIAN_C[30]/100,Q3_C[30]/100,MAX_C[30]/100]

MOD_NoC_minute_zero_R	= [MIN_R[0]/100,Q1_R[0]/100,MEDIAN_R[0]/100,Q3_R[0]/100,MAX_R[0]/100]
MOD_NoC_minute_fifteen_R = [MIN_R[15]/100,Q1_R[15]/100,MEDIAN_R[15]/100,Q3_R[15]/100,MAX_R[15]/100]
MOD_NoC_minute_thirty_R = [MIN_R[30]/100,Q1_R[30]/100,MEDIAN_R[30]/100,Q3_R[30]/100,MAX_R[30]/100]


data_MOD = [MOD_minute_thirty_L,MOD_minute_thirty_C,MOD_minute_thirty_R]
data_MOD_NoC = [MOD_NoC_minute_thirty_L,MOD_NoC_minute_thirty_C,MOD_NoC_minute_thirty_R]

ticks = ['Left zone', 'Center zone', 'Right zone']
...
def set_box_color_MOD_NoC(bp, color):
    plt.setp(bp['boxes'], color="black", linewidth=1.3)
    plt.setp(bp['whiskers'], color="black", linewidth=1.3)
    plt.setp(bp['caps'], color="black", linewidth=1.3)
...
bpl_MOD_NoC = plt.boxplot(data_MOD_NoC, positions=MOD_NoC, sym='x', widths=0.6, whis=20)
bpl_MOD = plt.boxplot(data_MOD, positions=MOD_wC, sym='x', widths=0.6, whis=20)
# bpl_MOD_NoC = plt.boxplot(data_MOD_NoC, positions=[-0.5,1.5,3.5], sym='x', widths=0.8, whis=20)
...
set_box_color_MOD(bpl_MOD_NoC, '#D7191C') # colors are from http://colorbrewer2.org/
set_box_color_MOD_NoC(bpl_MOD, '#D7191C') # colors are from http://colorbrewer2.org/
