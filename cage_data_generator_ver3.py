...
MOD_NoC_minute_zero_L	= [MIN_L[0],Q1_R[0],MEDIAN_L[0],Q3_L[0],MAX_L[0]]
MOD_NoC_minute_fifteen_L = [MIN_L[15],Q1_R[15],MEDIAN_L[15],Q3_L[15],MAX_L[15]]
MOD_NoC_minute_thirty_L = [MIN_L[30],Q1_R[30],MEDIAN_L[30],Q3_L[30],MAX_L[30]]

MOD_NoC_minute_zero_C	= [MIN_C[0],Q1_R[0],MEDIAN_C[0],Q3_C[0],MAX_C[0]]
MOD_NoC_minute_fifteen_C = [MIN_C[15],Q1_R[15],MEDIAN_C[15],Q3_C[15],MAX_C[15]]
MOD_NoC_minute_thirty_C = [MIN_C[30],Q1_R[30],MEDIAN_C[30],Q3_C[30],MAX_C[30]]

MOD_NoC_minute_zero_R	= [MIN_R[0],Q1_R[0],MEDIAN_R[0],Q3_R[0],MAX_R[0]]
MOD_NoC_minute_fifteen_R = [MIN_R[15],Q1_R[15],MEDIAN_R[15],Q3_R[15],MAX_R[15]]
MOD_NoC_minute_thirty_R = [MIN_R[30],Q1_R[30],MEDIAN_R[30],Q3_R[30],MAX_R[30]]
...
ticks = ['Left zone', 'Central zone', 'Right zone']
...
legend_elements = [Line2D([0], [0], color='r', lw=4, label='model'),Line2D([0], [0], color='b', lw=4, label='experiment')]
plt.legend(handles=legend_elements, loc='upper center')
